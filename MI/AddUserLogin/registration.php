        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <label for="intake"><b>Intake</b></label>
                    <select class="form-control" id="intake" name="intake" required>
                        ...
                        <option value="intake36">Intake 36</option>
                        <option value="intake36">Intake 35</option>
            ...
            if(valid){
               ...
               var firstname   = $('#firstname').val();
                ...
                $.ajax({
                    type: 'POST',
                    url: 'process.php',
                    data: {firstname: firstname, username: username, email: email, regno: regno,intake:intake, password: password, usertype: usertype, phonenumber: phonenumber},
