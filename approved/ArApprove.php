    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav text-center">
                ...
                <li class="nav-item"><a class="nav-link" href="../AR/ar.php">Home</a></li>
...
$query = "SELECT * FROM  medicalapply WHERE HODstatus = 'approved'  AND ARstatus= 'pending'"; //ORDER BY id ASC methnin doc apperove eka ayn wenna one
...
if(isset($_POST['approve'])){ // when pressing approve to table update status as pending to approve 
	...
	$id = $_POST['id'];
	$select = "UPDATE medicalapply SET ARstatus = 'Approved' WHERE id = '$id' ";
...
<?php 
$query = "SELECT * FROM  medicalapply WHERE ARstatus = 'Approved'   ";
$result = mysqli_query($conn,$query);
while($row = mysqli_fetch_array($result)) { ?>
