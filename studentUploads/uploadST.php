...
<body>
    ...
    <div class="alert alert-secondary" role="alert">
        <h4 class="text-center">Upload Image or PDF</h4>
    </div>
    <div class="container col-12 m-5">
      ...
      if(isset($_POST['btn_img']))
      {
        ...
        $folder = "studentUploads/image/".$filename;
        $sql = "INSERT INTO `images`(`studentUploads/image`)VALUES('$filename')";
        if($filename == "")
        {
            echo 
            "
        ...
        ?>
         ...
         <form action="uploadST.php" method="post" class="form-control" enctype="multipart/form-data">
        ...
        <table class="table text-center">
            ...
            while($fetch = mysqli_fetch_assoc($result2))
            {
                ...
                <tr>
                    ...
                    <td><img src="./studentUploads/image/<?php echo $fetch['image'] ?>" width=100px alt=""></td>
